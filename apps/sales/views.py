...
class VentaViewSet(SoftDeleteModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Verificamos si el usuario tiene rol y si ese rol es SUPERVISOR
        if request.user.id_rol and request.user.id_rol.codigo.upper() == 'SUPERVISOR':
            raise PermissionDenied({
                "error": "Operación denegada. Los supervisores solo pueden auditar y editar ventas, no crearlas."
            })
